...
modelo_grmf = LogisticRegression()
modelo_grmf.fit(X_treino, y_treino)

# Avaliando o modelo
predictions = modelo_grmf.predict(X_teste)
accuracy = accuracy_score(y_teste, predictions)
print(f"Acurácia do Modelo: {accuracy:.2f}")

# Salvando o modelo
joblib.dump(modelo_grmf, 'modelo_grmf_treinado.pkl')
